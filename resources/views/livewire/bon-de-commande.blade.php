                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6 col-lg-4 col-xxl-4">
                                    <div class="form-group">
                                        <label for="example-week-input" class="form-label">Nom client    @error('nom_client')
                                            <span class="text-danger">{{$message}}</span>
                                          @enderror</label>
                                            <input type="text" class="form-control" placeholder="Kahouo" wire:model="nom_client" required>
                                    </div>
                                </div>

                                <div class="col-md-6 col-lg-4 col-xxl-4">
                                    <div class="form-group">
                                        <label for="example-week-input" class="form-label">Prénom client  @error('prenom_client')
                                            <span class="text-danger">{{$message}}</span>
                                          @enderror</label>
                                            <input type="text" placeholder="Guy Stephane" class="form-control" wire:model="prenom_client" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4 col-xxl-4">
                                    <div class="form-group">
                                        <label for="example-week-input" class="form-label"> Email client     @error('email_client')
                                            <span class="text-danger">{{$message}}</span>
                                          @enderror</label>
                                            <input type="email" class="form-control" wire:model="email_client" placeholder="" required>
                                    </div>
                                </div>
