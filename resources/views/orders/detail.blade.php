...
<div class="main-content">
                            ...
                            <div>
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle table-nowrap table-centered mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <img src="{{Storage::url($ressource->image)}}" alt="">
                                                </th>
                                                <td>
                                                    <div>
                                                        <h5 class="text-truncate font-size-14 mb-1">{{$ressource->nom}}</h5>
                                                        <p class="text-muted mb-0">{{$ressource->marque->nom}}</p>
                                                    </div>
                                                </td>
                                                <td>{{$ressource->prix}} FCFA </td>
                                                <td>{{$ressource->pivot->quantity}}</td>
                                                <td class="text-end">{{$ressource->pivot->total}} FCFA </td>
                                            </tr>
                                            @endforeach
                                ...
                                <div class="d-print-none mt-4">
                                    <div class="float-end">
                                        ...
                                        <a href="{{route('invoice.commnde', $order->id)}}" class="btn btn-primary w-md">Send</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <footer class="footer">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <script>document.write(new Date().getFullYear())</script>2023 © Tocly.
                </div>
                <div class="col-sm-6">
